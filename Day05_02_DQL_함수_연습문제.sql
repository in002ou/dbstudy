...
SELECT ROW_NUMBER() OVER(ORDER BY JOB_ID ASC)
     , JOB_ID
  FROM EMPLOYEES
 GROUP BY JOB_ID;
...
SELECT DEPARTMENT_ID
     ...
     , LAST_NAME
  FROM EMPLOYEES
 GROUP BY FIRST_NAME, LAST_NAME, DEPARTMENT_ID, SALARY
HAVING DEPARTMENT_ID = 50 AND SALARY >= 5000;
...
SELECT HIRE_DATE
  FROM EMPLOYEES
 WHERE TO_DATE(HIRE_DATE, 'YY') = TO_DATE('05/01/01', 'YY');
