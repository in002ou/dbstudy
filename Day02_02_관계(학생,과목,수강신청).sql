...
CREATE TABLE ENROLL_TBL (
    ...
    CONSTRAINT FK_ENROLL_STU FOREIGN KEY(STU_NO)   REFERENCES STUDENT_TBL(STU_NO)   ON DELETE CASCADE,
    CONSTRAINT FK_ENROLL_SUB FOREIGN KEY(SUB_CODE) REFERENCES SUBJECT_TBL(SUB_CODE) ON DELETE CASCADE
);
