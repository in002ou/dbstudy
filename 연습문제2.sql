...
CREATE SEQUENCE ORDER_SEQ
    NOCACHE;
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES(SYSDATE || '-' || ORDER_SEQ.NEXTVAL, 1000, 1, 1, '20/07/01');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES(SYSDATE || '-' || ORDER_SEQ.NEXTVAL, 1000, 3, 2, '20/07/03');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES(SYSDATE || '-' || ORDER_SEQ.NEXTVAL, 1001, 5, 1, '20/07/03');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES(SYSDATE || '-' || ORDER_SEQ.NEXTVAL, 1002, 6, 2, '20/07/04');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES(SYSDATE || '-' || ORDER_SEQ.NEXTVAL, 1003, 7, 3, '20/07/05');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES(SYSDATE || '-' || ORDER_SEQ.NEXTVAL, 1000, 2, 5, '20/07/07');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES(SYSDATE || '-' || ORDER_SEQ.NEXTVAL, 1003, 8, 2, '20/07/07');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES(SYSDATE || '-' || ORDER_SEQ.NEXTVAL, 1002, 10, 2, '20/07/08');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES(SYSDATE || '-' || ORDER_SEQ.NEXTVAL, 1001, 10, 1, '20/07/09');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES(SYSDATE || '-' || ORDER_SEQ.NEXTVAL, 1002, 6, 4, '20/07/10');
COMMIT;
...
ALTER TABLE ORDER_TBL
    ADD CONSTRAINT FK_ORDER_CUSTOMER FOREIGN KEY(CUSTOMER_ID) REFERENCES CUSTOMER_TBL(CUSTOMER_ID);
ALTER TABLE ORDER_TBL
    ADD CONSTRAINT FK_ORDER_BOOK FOREIGN KEY(BOOK_ID) REFERENCES BOOK_TBL(BOOK_ID);
