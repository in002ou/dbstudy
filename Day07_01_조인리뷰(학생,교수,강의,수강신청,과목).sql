...
-- 교수번호, 교수이름, 교수전공, 강의명, 강의실를 조회하시오
SELECT P.P_NO AS 교수번호, P.P_NAME AS 교수명, P.P_MAJOR AS 교수전공, L.L_NAME AS 강의명, L.L_LOCATION AS 강의실
...
-- 모든 교수들의 교수이름, 교수전공, 강의이름 조회
SELECT P.P_NAME, P.P_MAJOR, L.L_NAME
  FROM PROFESSOR_TBL P LEFT JOIN LECTURE_TBL L
    ON P.P_NO = L.P_NO;
